        ...
        return (
            <div className="whoarewe-container" id={this.props.id}>
                ...
                <p className="whoarewe-content">
                    ...
                    MTBS is always at the outlook to diversify our profile and product range to best suit the industrial requirements of the Middle East region and we represent (or) hold agency agreements with internationally well renowned OEM’s.<br/><br/>
                </p>
            </div>
        )
    }
